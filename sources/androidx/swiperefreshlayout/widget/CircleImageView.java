...
import androidx.swiperefreshlayout.C0432R;
...
class CircleImageView extends ImageView {
    ...
    CircleImageView(Context context) {
        ...
        TypedArray obtainStyledAttributes = getContext().obtainStyledAttributes(C0432R.styleable.SwipeRefreshLayout);
        this.mBackgroundColor = obtainStyledAttributes.getColor(C0432R.styleable.f66xaa980688, DEFAULT_BACKGROUND_COLOR);
