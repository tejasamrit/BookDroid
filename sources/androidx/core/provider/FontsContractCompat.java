...
public class FontsContractCompat {
    ...
    private static final Comparator<byte[]> sByteArrayComparator = new Comparator<byte[]>() {
        ...
        public int compare(byte[] r5, byte[] r6) {
            ...
            L_0x001b:
                return r0
            */
            throw new UnsupportedOperationException("Method not decompiled: androidx.core.provider.FontsContractCompat.C02245.compare(byte[], byte[]):int");
        }
    };
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:36:0x0083, code lost:
        sBackgroundThread.postAndReply(r1, new androidx.core.provider.FontsContractCompat.C02133());
     */
    ...
    public static android.graphics.Typeface getFontSync(final android.content.Context r2, final androidx.core.provider.FontRequest r3, final androidx.core.content.res.ResourcesCompat.FontCallback r4, final android.os.Handler r5, boolean r6, int r7, final int r8) {
        ...
        L_0x0061:
            ...
            java.lang.Object r6 = r5.get(r0)     // Catch:{ all -> 0x008e }
            java.util.ArrayList r6 = (java.util.ArrayList) r6     // Catch:{ all -> 0x008e }
            if (r6 == 0) goto L_0x0075
            if (r3 == 0) goto L_0x0073
            r6.add(r3)     // Catch:{ all -> 0x008e }
        L_0x0073:
            monitor-exit(r4)     // Catch:{ all -> 0x008e }
            return r2
        L_0x0075:
            if (r3 == 0) goto L_0x0082
            java.util.ArrayList r6 = new java.util.ArrayList     // Catch:{ all -> 0x008e }
            r6.<init>()     // Catch:{ all -> 0x008e }
            r6.add(r3)     // Catch:{ all -> 0x008e }
            r5.put(r0, r6)     // Catch:{ all -> 0x008e }
        L_0x0082:
            monitor-exit(r4)     // Catch:{ all -> 0x008e }
        ...
        try {
            ...
            if (cursor != null && cursor.getCount() > 0) {
                ...
                while (cursor.moveToNext()) {
                    ...
                    arrayList2.add(new FontInfo(uri, i2, columnIndex5 != -1 ? cursor.getInt(columnIndex5) : LogSeverity.WARNING_VALUE, columnIndex6 != -1 && cursor.getInt(columnIndex6) == 1, i));
                }
