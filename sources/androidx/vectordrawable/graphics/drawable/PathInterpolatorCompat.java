...
public class PathInterpolatorCompat implements Interpolator {
    ...
    private void initPath(Path path) {
        ...
        if (min > 0) {
            this.f68mX = new float[min];
            this.f69mY = new float[min];
            ...
            if (((double) Math.abs(this.f68mX[0])) <= 1.0E-5d && ((double) Math.abs(this.f69mY[0])) <= 1.0E-5d) {
                int i3 = min - 1;
                if (((double) Math.abs(this.f68mX[i3] - 1.0f)) <= 1.0E-5d && ((double) Math.abs(this.f69mY[i3] - 1.0f)) <= 1.0E-5d) {
                    float f = 0.0f;
                    int i4 = 0;
                    while (i < min) {
