...
public class MotionController {
    ...
    public void buildPath(float[] r21, int r22) {
        ...
        L_0x0076:
            ...
            androidx.constraintlayout.motion.utils.Easing r9 = r15.mKeyFrameEasing
        ...
        L_0x00ba:
            ...
            r12 = 0
            r9 = r9[r12]
            double[] r13 = r0.mInterpolateData
            r9.getPos((double) r4, (double[]) r13)
            androidx.constraintlayout.motion.utils.CurveFit r9 = r0.mArcSpline
    ...
    public void setup(int i, int i2, float f, long j) {
        ...
        if (motionPathsArr[0].mPathMotionArc != Key.UNSET) {
            ...
            for (int i18 = 0; i18 < size; i18++) {
                ...
                dArr6[i18][0] = (double) motionPathsArr[i18].f29x;
                dArr6[i18][1] = (double) motionPathsArr[i18].f30y;
            }
