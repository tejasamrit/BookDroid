...
public class ListMenuItemView extends LinearLayout implements MenuView.ItemView, AbsListView.SelectionBoundsAdjuster {
    ...
    public void onFinishInflate() {
        ...
        TextView textView = (TextView) findViewById(C0041R.C0044id.title);
        this.mTitleView = textView;
        int i = this.mTextAppearance;
        if (i != -1) {
            textView.setTextAppearance(this.mTextAppearanceContext, i);
        }
        this.mShortcutView = (TextView) findViewById(C0041R.C0044id.shortcut);
        ImageView imageView = (ImageView) findViewById(C0041R.C0044id.submenuarrow);
        this.mSubMenuArrowView = imageView;
        if (imageView != null) {
            imageView.setImageDrawable(this.mSubMenuArrow);
        }
        this.mGroupDivider = (ImageView) findViewById(C0041R.C0044id.group_divider);
        this.mContent = (LinearLayout) findViewById(C0041R.C0044id.content);
    }
