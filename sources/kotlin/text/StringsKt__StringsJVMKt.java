...
class StringsKt__StringsJVMKt extends StringsKt__StringNumberConversionsKt {
    ...
    public static final String replace(String str, char c, char c2, boolean z) {
        String str2 = str;
        Intrinsics.checkNotNullParameter(str2, "$this$replace");
        if (!z) {
    ...
    public static final String replace(String str, String str2, String str3, boolean z) {
        ...
        String str5 = str2;
        String str6 = str3;
        Intrinsics.checkNotNullParameter(str4, "$this$replace");
        Intrinsics.checkNotNullParameter(str5, "oldValue");
        Intrinsics.checkNotNullParameter(str6, "newValue");
