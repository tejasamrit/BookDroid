...
class StrictLineReader implements Closeable {
    ...
    /* renamed from: CR */
    private static final byte f112CR = 13;

    /* renamed from: LF */
    private static final byte f113LF = 10;
    private byte[] buf;
    ...
    /* renamed from: in */
    private final InputStream f114in;
    private int pos;
    ...
    public String readLine() throws IOException {
        ...
        synchronized (this.f114in) {
            if (this.buf != null) {
                ...
                C07701 r1 = new ByteArrayOutputStream((this.end - this.pos) + 80) {
    ...
    private void fillBuf() throws IOException {
        InputStream inputStream = this.f114in;
        byte[] bArr = this.buf;
