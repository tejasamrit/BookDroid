...
public class GifHeaderParser {
    ...
    private void readBitmap() {
        this.header.currentFrame.f117ix = readShort();
        this.header.currentFrame.f118iy = readShort();
        this.header.currentFrame.f116iw = readShort();
        this.header.currentFrame.f115ih = readShort();
        int read = read();
        boolean z = false;
