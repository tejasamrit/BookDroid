...
public final class HttpUrl {
    ...
    /* synthetic */ HttpUrl(Builder builder, C22911 r2) {
        this(builder);
    }
    ...
    static HttpUrl getChecked(String str) throws MalformedURLException, UnknownHostException {
        ...
        int i = C22911.$SwitchMap$com$squareup$okhttp$HttpUrl$Builder$ParseResult[parse.ordinal()];
        if (i == 1) {
            return builder.build();
        }
        if (i != 2) {
    ...
    static /* synthetic */ class C22911 {
        ...
        static {
            /*
                ...
                int r0 = r0.length
                int[] r0 = new int[r0]
                $SwitchMap$com$squareup$okhttp$HttpUrl$Builder$ParseResult = r0
                com.squareup.okhttp.HttpUrl$Builder$ParseResult r1 = com.squareup.okhttp.HttpUrl.Builder.ParseResult.SUCCESS     // Catch:{ NoSuchFieldError -> 0x0012 }
                int r1 = r1.ordinal()     // Catch:{ NoSuchFieldError -> 0x0012 }
                r2 = 1
                r0[r1] = r2     // Catch:{ NoSuchFieldError -> 0x0012 }
            L_0x0012:
                int[] r0 = $SwitchMap$com$squareup$okhttp$HttpUrl$Builder$ParseResult     // Catch:{ NoSuchFieldError -> 0x001d }
                com.squareup.okhttp.HttpUrl$Builder$ParseResult r1 = com.squareup.okhttp.HttpUrl.Builder.ParseResult.INVALID_HOST     // Catch:{ NoSuchFieldError -> 0x001d }
                int r1 = r1.ordinal()     // Catch:{ NoSuchFieldError -> 0x001d }
                r2 = 2
                r0[r1] = r2     // Catch:{ NoSuchFieldError -> 0x001d }
            L_0x001d:
                int[] r0 = $SwitchMap$com$squareup$okhttp$HttpUrl$Builder$ParseResult     // Catch:{ NoSuchFieldError -> 0x0028 }
                com.squareup.okhttp.HttpUrl$Builder$ParseResult r1 = com.squareup.okhttp.HttpUrl.Builder.ParseResult.UNSUPPORTED_SCHEME     // Catch:{ NoSuchFieldError -> 0x0028 }
                int r1 = r1.ordinal()     // Catch:{ NoSuchFieldError -> 0x0028 }
                r2 = 3
                r0[r1] = r2     // Catch:{ NoSuchFieldError -> 0x0028 }
            L_0x0028:
                int[] r0 = $SwitchMap$com$squareup$okhttp$HttpUrl$Builder$ParseResult     // Catch:{ NoSuchFieldError -> 0x0033 }
                com.squareup.okhttp.HttpUrl$Builder$ParseResult r1 = com.squareup.okhttp.HttpUrl.Builder.ParseResult.MISSING_SCHEME     // Catch:{ NoSuchFieldError -> 0x0033 }
                int r1 = r1.ordinal()     // Catch:{ NoSuchFieldError -> 0x0033 }
                r2 = 4
                r0[r1] = r2     // Catch:{ NoSuchFieldError -> 0x0033 }
            L_0x0033:
                int[] r0 = $SwitchMap$com$squareup$okhttp$HttpUrl$Builder$ParseResult     // Catch:{ NoSuchFieldError -> 0x003e }
                com.squareup.okhttp.HttpUrl$Builder$ParseResult r1 = com.squareup.okhttp.HttpUrl.Builder.ParseResult.INVALID_PORT     // Catch:{ NoSuchFieldError -> 0x003e }
            ...
            L_0x003e:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.squareup.okhttp.HttpUrl.C22911.<clinit>():void");
        }
    }
    ...
    public static final class Builder {
        ...
        public HttpUrl build() {
            if (this.scheme == null) {
                ...
                return new HttpUrl(this, (C22911) null);
            } else {
        ...
        public ParseResult parse(HttpUrl httpUrl, String str) {
            ...
            if (slashCount >= 2 || httpUrl == null || !httpUrl.scheme.equals(this.scheme)) {
                ...
                boolean z2 = false;
                while (true) {
                    access$200 = HttpUrl.delimiterOffset(str2, i2, skipTrailingAsciiWhitespace, "@/\\?#");
                    ...
                    if (charAt == 65535 || charAt == c2 || charAt == '/' || charAt == '\\' || charAt == c) {
                        ...
                        if (charAt == '@') {
                            if (!z) {
                                int access$2002 = HttpUrl.delimiterOffset(str2, i2, access$200, ":");
                                int i5 = access$2002;
                                String str3 = "%40";
                                i = access$200;
                                ...
                                if (i5 != i) {
                                    this.encodedPassword = HttpUrl.canonicalize(str, i5 + 1, i, " \"':;<=>@[]^`{}|/\\?#", true, false, true);
                                    z = true;
                                }
                                z2 = true;
                            } else {
            ...
            int access$2003 = HttpUrl.delimiterOffset(str2, skipLeadingAsciiWhitespace, skipTrailingAsciiWhitespace, "?#");
            ...
            if (access$2003 < skipTrailingAsciiWhitespace && str2.charAt(access$2003) == '?') {
                ...
                this.encodedQueryNamesAndValues = HttpUrl.queryStringToNamesAndValues(HttpUrl.canonicalize(str, access$2003 + 1, access$2004, HttpUrl.QUERY_ENCODE_SET, true, true, true));
                    ...
                    if (i6 > i2 || !str.regionMatches(i, "::", 0, 2)) {
                        if (i3 != 0) {
                            if (str.regionMatches(i, ":", 0, 1)) {
                                i++;
                            } else if (!str.regionMatches(i, FileUtils.HIDDEN_PREFIX, 0, 1) || !decodeIpv4Suffix(str, i5, i2, bArr, i3 - 2)) {
                                return null;
                            } else {
                                i3 += 2;
                            }
            ...
            if (!z || !(codePointAt == 9 || codePointAt == 10 || codePointAt == 12 || codePointAt == 13)) {
                if (codePointAt == 43 && z2) {
                    ...
                    while (!buffer2.exhausted()) {
                        ...
                        buffer.writeByte((int) cArr[readByte & Ascii.f233SI]);
                    }
                } else {
                    buffer.writeUtf8CodePoint(codePointAt);
                }
