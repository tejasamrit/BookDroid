...
final class Hpack {
    ...
    static final class Reader {
        ...
        public ByteString readByteString() throws IOException {
            ...
            if (z) {
                return ByteString.m292of(Huffman.get().decode(this.source.readByteArray((long) readInt)));
            }
