...
public final class FramedStream {
    ...
    public boolean isLocallyInitiated() {
        if (this.connection.client == ((this.f485id & 1) == 1)) {
            return true;
        }
        return false;
    }
    ...
    public void reply(List<Header> list, boolean z) throws IOException {
        ...
        this.connection.writeSynReply(this.f485id, z2, list);
        if (z2) {
    ...
    public void close(ErrorCode errorCode2) throws IOException {
        if (closeInternal(errorCode2)) {
            this.connection.writeSynReset(this.f485id, errorCode2);
        }
    }

    public void closeLater(ErrorCode errorCode2) {
        if (closeInternal(errorCode2)) {
            this.connection.writeSynResetLater(this.f485id, errorCode2);
        }
    }
    ...
    private boolean closeInternal(ErrorCode errorCode2) {
        synchronized (this) {
            ...
            notifyAll();
            this.connection.removeStream(this.f485id);
            return true;
        }
    }
    ...
    private final class FramedDataSource implements Source {
        ...
        /* JADX WARNING: Code restructure failed: missing block: B:18:0x008e, code lost:
            if (com.squareup.okhttp.internal.framed.FramedStream.access$500(r8.this$0).unacknowledgedBytesRead < ((long) (com.squareup.okhttp.internal.framed.FramedStream.access$500(r8.this$0).okHttpSettings.getInitialWindowSize(65536) / 2))) goto L_0x00aa;
         */
        ...
        public long read(okio.Buffer r9, long r10) throws java.io.IOException {
            /*
                ...
                okio.Buffer r3 = r8.readBuffer     // Catch:{ all -> 0x00af }
            ...
            L_0x001d:
                ...
                com.squareup.okhttp.internal.framed.FramedStream r11 = com.squareup.okhttp.internal.framed.FramedStream.this     // Catch:{ all -> 0x00af }
                ...
                long r3 = r11.unacknowledgedBytesRead     // Catch:{ all -> 0x00af }
                com.squareup.okhttp.internal.framed.FramedStream r11 = com.squareup.okhttp.internal.framed.FramedStream.this     // Catch:{ all -> 0x00af }
                com.squareup.okhttp.internal.framed.FramedConnection r11 = r11.connection     // Catch:{ all -> 0x00af }
                com.squareup.okhttp.internal.framed.Settings r11 = r11.okHttpSettings     // Catch:{ all -> 0x00af }
                ...
                com.squareup.okhttp.internal.framed.FramedStream r11 = com.squareup.okhttp.internal.framed.FramedStream.this     // Catch:{ all -> 0x00af }
                com.squareup.okhttp.internal.framed.FramedConnection r11 = r11.connection     // Catch:{ all -> 0x00af }
                com.squareup.okhttp.internal.framed.FramedStream r3 = com.squareup.okhttp.internal.framed.FramedStream.this     // Catch:{ all -> 0x00af }
                int r3 = r3.f485id     // Catch:{ all -> 0x00af }
                com.squareup.okhttp.internal.framed.FramedStream r4 = com.squareup.okhttp.internal.framed.FramedStream.this     // Catch:{ all -> 0x00af }
            ...
            L_0x0062:
                ...
                monitor-enter(r11)
                com.squareup.okhttp.internal.framed.FramedStream r2 = com.squareup.okhttp.internal.framed.FramedStream.this     // Catch:{ all -> 0x00ac }
                com.squareup.okhttp.internal.framed.FramedConnection r2 = r2.connection     // Catch:{ all -> 0x00ac }
                ...
                com.squareup.okhttp.internal.framed.FramedStream r4 = com.squareup.okhttp.internal.framed.FramedStream.this     // Catch:{ all -> 0x00ac }
                com.squareup.okhttp.internal.framed.FramedConnection r4 = r4.connection     // Catch:{ all -> 0x00ac }
                com.squareup.okhttp.internal.framed.Settings r4 = r4.okHttpSettings     // Catch:{ all -> 0x00ac }
                ...
                com.squareup.okhttp.internal.framed.FramedStream r4 = com.squareup.okhttp.internal.framed.FramedStream.this     // Catch:{ all -> 0x00ac }
                com.squareup.okhttp.internal.framed.FramedConnection r4 = r4.connection     // Catch:{ all -> 0x00ac }
                long r4 = r4.unacknowledgedBytesRead     // Catch:{ all -> 0x00ac }
                r2.writeWindowUpdateLater(r3, r4)     // Catch:{ all -> 0x00ac }
                com.squareup.okhttp.internal.framed.FramedStream r2 = com.squareup.okhttp.internal.framed.FramedStream.this     // Catch:{ all -> 0x00ac }
                com.squareup.okhttp.internal.framed.FramedConnection r2 = r2.connection     // Catch:{ all -> 0x00ac }
                r2.unacknowledgedBytesRead = r0     // Catch:{ all -> 0x00ac }
            L_0x00aa:
    ...
    final class FramedDataSink implements Sink {
        ...
        private void emitDataFrame(boolean z) throws IOException {
            ...
            FramedStream.this.writeTimeout.enter();
            try {
                FramedStream.this.connection.writeData(FramedStream.this.f485id, z && min == this.sendBuffer.size(), this.sendBuffer, min);
            } finally {
                FramedStream.this.writeTimeout.exitAndThrowIfTimedOut();
            }
        }
