...
public class SwapAnimation extends BaseAnimation<ValueAnimator> {
    ...
    public SwapAnimation with(int i, int i2) {
        if (this.animator != null && hasChanges(i, i2)) {
            ...
            ((ValueAnimator) this.animator).setValues(new PropertyValuesHolder[]{createColorPropertyHolder(ANIMATION_COORDINATE, i, i2), createColorPropertyHolder(ANIMATION_COORDINATE_REVERSE, i2, i)});
        }
        return this;
    }
