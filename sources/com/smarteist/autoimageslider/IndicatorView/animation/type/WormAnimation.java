...
public class WormAnimation extends BaseAnimation<AnimatorSet> {
    ...
    public WormAnimation with(int i, int i2, int i3, boolean z) {
        if (hasChanges(i, i2, i3, z)) {
            ...
            ((AnimatorSet) this.animator).playSequentially(new Animator[]{createWormAnimator(createRectValues.fromX, createRectValues.toX, j, false, this.value), createWormAnimator(createRectValues.reverseFromX, createRectValues.reverseToX, j, true, this.value)});
        }
        return this;
    }
    ...
    public ValueAnimator createWormAnimator(int i, int i2, long j, final boolean z, final WormAnimationValue wormAnimationValue) {
