...
public class SliderPager extends ViewGroup {
    ...
    public interface OnAdapterChangeListener {
        void onAdapterChanged(SliderPager sliderPager, PagerAdapter pagerAdapter, PagerAdapter pagerAdapter2);
    }
    ...
    public void initSliderPager() {
        setWillNotDraw(false);
        setDescendantFocusability(262144);
        setFocusable(true);
        Context context = getContext();
        this.mScroller = new OwnScroller(context, 250, sInterpolator);
        ...
        ViewCompat.setOnApplyWindowInsetsListener(this, new OnApplyWindowInsetsListener() {
            ...
            public WindowInsetsCompat onApplyWindowInsets(View view, WindowInsetsCompat windowInsetsCompat) {
                ...
                for (int i = 0; i < childCount; i++) {
                    WindowInsetsCompat dispatchApplyWindowInsets = ViewCompat.dispatchApplyWindowInsets(SliderPager.this.getChildAt(i), onApplyWindowInsets);
    ...
    public void setAdapter(PagerAdapter pagerAdapter) {
        if (this.mAdapter != null) {
            setAdapterViewPagerObserver((PagerObserver) null);
        ...
        if (pagerAdapter != null) {
            ...
            setAdapterViewPagerObserver(this.mObserver);
            try {
    ...
    private void setAdapterViewPagerObserver(PagerObserver pagerObserver) {
        try {
            Method declaredMethod = PagerAdapter.class.getDeclaredMethod("setViewPagerObserver", new Class[]{DataSetObserver.class});
            declaredMethod.setAccessible(true);
            declaredMethod.invoke(this.mAdapter, new Object[]{pagerObserver});
        } catch (Exception e) {
            e.printStackTrace();
        }
    }
    ...
    public void setCurrentItem(int i, boolean z) {
        ...
        if (pagerAdapter instanceof InfinitePagerAdapter) {
            i = ((InfinitePagerAdapter) pagerAdapter).getMiddlePosition(i);
        }
        this.mPopulatePending = false;
    ...
    public void setScrollDuration(int i, Interpolator interpolator) {
        if (interpolator != null) {
            this.mScroller = new OwnScroller(getContext(), i, interpolator);
        } else {
            this.mScroller = new OwnScroller(getContext(), i);
        }
    }

    public void setScrollDuration(int i) {
        setScrollDuration(i, (Interpolator) null);
    }
    ...
    public void populate(int r18) {
        /*
            ...
            com.smarteist.autoimageslider.SliderPager$ItemInfo r2 = r0.infoForPosition(r2)
            r0.mCurItem = r1
            goto L_0x0010
        L_0x000f:
            r2 = 0
        ...
        L_0x0027:
            ...
            r7 = 0
        L_0x004a:
            java.util.ArrayList<com.smarteist.autoimageslider.SliderPager$ItemInfo> r8 = r0.mItems
            int r8 = r8.size()
            if (r7 >= r8) goto L_0x006a
            java.util.ArrayList<com.smarteist.autoimageslider.SliderPager$ItemInfo> r8 = r0.mItems
            java.lang.Object r8 = r8.get(r7)
            com.smarteist.autoimageslider.SliderPager$ItemInfo r8 = (com.smarteist.autoimageslider.SliderPager.ItemInfo) r8
            int r9 = r8.position
            int r10 = r0.mCurItem
        ...
        L_0x006b:
            ...
            int r8 = r0.mCurItem
            com.smarteist.autoimageslider.SliderPager$ItemInfo r8 = r0.addNewItem(r8, r7)
        L_0x0075:
            r9 = 0
            if (r8 == 0) goto L_0x019f
            int r10 = r7 + -1
            if (r10 < 0) goto L_0x0085
            java.util.ArrayList<com.smarteist.autoimageslider.SliderPager$ItemInfo> r11 = r0.mItems
            java.lang.Object r11 = r11.get(r10)
            com.smarteist.autoimageslider.SliderPager$ItemInfo r11 = (com.smarteist.autoimageslider.SliderPager.ItemInfo) r11
            goto L_0x0086
        L_0x0085:
            r11 = 0
        L_0x0086:
        ...
        L_0x00ac:
            ...
            java.util.ArrayList<com.smarteist.autoimageslider.SliderPager$ItemInfo> r5 = r0.mItems
            r5.remove(r10)
            ...
            com.smarteist.autoimageslider.SliderPager$ItemInfo r5 = (com.smarteist.autoimageslider.SliderPager.ItemInfo) r5
            goto L_0x00fc
        L_0x00cf:
        ...
        L_0x00e5:
            int r5 = r10 + 1
            com.smarteist.autoimageslider.SliderPager$ItemInfo r5 = r0.addNewItem(r3, r5)
        ...
        L_0x0136:
            ...
            java.util.ArrayList<com.smarteist.autoimageslider.SliderPager$ItemInfo> r12 = r0.mItems
            r12.remove(r4)
        ...
        L_0x015d:
            ...
            goto L_0x0192
        L_0x0179:
            com.smarteist.autoimageslider.SliderPager$ItemInfo r5 = r0.addNewItem(r11, r4)
            int r4 = r4 + 1
            float r5 = r5.widthFactor
            float r3 = r3 + r5
            java.util.ArrayList<com.smarteist.autoimageslider.SliderPager$ItemInfo> r5 = r0.mItems
        ...
        L_0x01a9:
            ...
            com.smarteist.autoimageslider.SliderPager$LayoutParams r4 = (com.smarteist.autoimageslider.SliderPager.LayoutParams) r4
            r4.childIndex = r2
            ...
            if (r5 != 0) goto L_0x01cf
            com.smarteist.autoimageslider.SliderPager$ItemInfo r3 = r0.infoForChild(r3)
        ...
        L_0x01d2:
            ...
            com.smarteist.autoimageslider.SliderPager$ItemInfo r3 = r0.infoForAnyChild(r1)
            goto L_0x01e7
        L_0x01e6:
            r3 = 0
        L_0x01e7:
        ...
        L_0x01f0:
            ...
            com.smarteist.autoimageslider.SliderPager$ItemInfo r2 = r0.infoForChild(r1)
        ...
        L_0x0227:
            ...
            throw r2
        */
        throw new UnsupportedOperationException("Method not decompiled: com.smarteist.autoimageslider.SliderPager.populate(int):void");
    }
    ...
    private void triggerOnPageChangeEvent(int i) {
        for (OnPageChangeListener next : this.mOnPageChangeListeners) {
            if (next != null) {
                PagerAdapter pagerAdapter = this.mAdapter;
                if (pagerAdapter instanceof InfinitePagerAdapter) {
                    next.onPageSelected(((InfinitePagerAdapter) pagerAdapter).getRealPosition(i));
                } else {
    ...
    public void onMeasure(int r17, int r18) {
        ...
        L_0x003d:
            ...
            com.smarteist.autoimageslider.SliderPager$LayoutParams r6 = (com.smarteist.autoimageslider.SliderPager.LayoutParams) r6
        ...
        L_0x00dd:
            ...
            com.smarteist.autoimageslider.SliderPager$LayoutParams r5 = (com.smarteist.autoimageslider.SliderPager.LayoutParams) r5
    ...
    public void onLayout(boolean r19, int r20, int r21, int r22, int r23) {
        ...
        L_0x00bb:
            ...
            com.smarteist.autoimageslider.SliderPager$ItemInfo r10 = r0.infoForChild(r8)
            if (r10 == 0) goto L_0x0107
            float r13 = (float) r2
    ...
    public void onPageScrolled(int r13, float r14, int r15) {
        ...
        L_0x006b:
            ...
            com.smarteist.autoimageslider.SliderPager$PageTransformer r13 = r12.mPageTransformer
        ...
        L_0x007a:
            ...
            com.smarteist.autoimageslider.SliderPager$LayoutParams r0 = (com.smarteist.autoimageslider.SliderPager.LayoutParams) r0
        ...
        L_0x008b:
            ...
            float r3 = (float) r3
            float r0 = r0 / r3
            com.smarteist.autoimageslider.SliderPager$PageTransformer r3 = r12.mPageTransformer
        ...
        L_0x009f:
            ...
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: com.smarteist.autoimageslider.SliderPager.onPageScrolled(int, float, int):void");
    }
    ...
    public boolean arrowScroll(int r7) {
        ...
        L_0x00d6:
            return r2
        */
        throw new UnsupportedOperationException("Method not decompiled: com.smarteist.autoimageslider.SliderPager.arrowScroll(int):boolean");
    }
    ...
    class MyAccessibilityDelegate extends AccessibilityDelegateCompat {
        ...
        public void onInitializeAccessibilityEvent(View view, AccessibilityEvent accessibilityEvent) {
            ...
            if (accessibilityEvent.getEventType() == 4096 && SliderPager.this.mAdapter != null) {
                accessibilityEvent.setItemCount(SliderPager.this.mAdapter.getCount());
                accessibilityEvent.setFromIndex(SliderPager.this.mCurItem);
                accessibilityEvent.setToIndex(SliderPager.this.mCurItem);
            }
        }
        ...
        public boolean performAccessibilityAction(View view, int i, Bundle bundle) {
            ...
            if (i != 4096) {
                if (i != 8192 || !SliderPager.this.canScrollHorizontally(-1)) {
                    return false;
                }
                SliderPager sliderPager = SliderPager.this;
                sliderPager.setCurrentItem(sliderPager.mCurItem - 1);
                return true;
            } else if (!SliderPager.this.canScrollHorizontally(1)) {
                return false;
            } else {
                SliderPager sliderPager2 = SliderPager.this;
                sliderPager2.setCurrentItem(sliderPager2.mCurItem + 1);
                return true;
            }
        }

        private boolean canScroll() {
            return SliderPager.this.mAdapter != null && SliderPager.this.mAdapter.getCount() > 1;
        }
    }
    ...
    private class PagerObserver extends DataSetObserver {
        ...
        public void onChanged() {
            SliderPager.this.dataSetChanged();
        }
    ...
    class OwnScroller extends Scroller {
        ...
        OwnScroller(Context context, int i) {
            super(context, SliderPager.sInterpolator);
            this.durationScrollMillis = i;
        }

        OwnScroller(Context context, int i, Interpolator interpolator) {
    ...
    public static class LayoutParams extends ViewGroup.LayoutParams {
        ...
        public LayoutParams(Context context, AttributeSet attributeSet) {
            super(context, attributeSet);
            TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, SliderPager.LAYOUT_ATTRS);
