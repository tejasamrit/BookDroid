...
public final class TypeAdapters {
    ...
    public static final TypeAdapterFactory ENUM_FACTORY = new TypeAdapterFactory() {
        ...
        public <T> com.google.gson.TypeAdapter<T> create(com.google.gson.Gson r1, com.google.gson.reflect.TypeToken<T> r2) {
            ...
            L_0x0021:
                ...
                return r1
            */
            throw new UnsupportedOperationException("Method not decompiled: com.google.gson.internal.bind.TypeAdapters.C207830.create(com.google.gson.Gson, com.google.gson.reflect.TypeToken):com.google.gson.TypeAdapter");
        }
    };
    ...
    static {
        ...
        TypeAdapter<BitSet> nullSafe2 = new TypeAdapter<BitSet>() {
            ...
            public java.util.BitSet read(com.google.gson.stream.JsonReader r8) throws java.io.IOException {
                ...
                L_0x000e:
                    ...
                    int[] r4 = com.google.gson.internal.bind.TypeAdapters.C208536.$SwitchMap$com$google$gson$stream$JsonToken
                    int r5 = r1.ordinal()
                    r4 = r4[r5]
                    r5 = 1
                ...
                L_0x0075:
                    ...
                    return r0
                */
                throw new UnsupportedOperationException("Method not decompiled: com.google.gson.internal.bind.TypeAdapters.C20652.read(com.google.gson.stream.JsonReader):java.util.BitSet");
            }
        ...
        C20773 r0 = new TypeAdapter<Boolean>() {
            public Boolean read(JsonReader jsonReader) throws IOException {
        ...
        C20875 r02 = new TypeAdapter<Number>() {
            public Number read(JsonReader jsonReader) throws IOException {
                if (jsonReader.peek() == JsonToken.NULL) {
                    jsonReader.nextNull();
                    return null;
        ...
        C20886 r03 = new TypeAdapter<Number>() {
            public Number read(JsonReader jsonReader) throws IOException {
                if (jsonReader.peek() == JsonToken.NULL) {
                    jsonReader.nextNull();
                    return null;
        ...
        C20897 r04 = new TypeAdapter<Number>() {
            public Number read(JsonReader jsonReader) throws IOException {
                if (jsonReader.peek() == JsonToken.NULL) {
                    jsonReader.nextNull();
                    return null;
        ...
        C205914 r05 = new TypeAdapter<Number>() {
            public Number read(JsonReader jsonReader) throws IOException {
                JsonToken peek = jsonReader.peek();
                int i = C208536.$SwitchMap$com$google$gson$stream$JsonToken[peek.ordinal()];
                if (i == 1 || i == 3) {
        ...
        C206015 r06 = new TypeAdapter<Character>() {
        ...
        C206116 r07 = new TypeAdapter<String>() {
        ...
        C206419 r08 = new TypeAdapter<StringBuilder>() {
        ...
        C206620 r09 = new TypeAdapter<StringBuffer>() {
        ...
        C206721 r010 = new TypeAdapter<URL>() {
        ...
        C206822 r011 = new TypeAdapter<URI>() {
        ...
        C206923 r012 = new TypeAdapter<InetAddress>() {
        ...
        C207024 r013 = new TypeAdapter<UUID>() {
        ...
        C207427 r014 = new TypeAdapter<Calendar>() {
        ...
        C207528 r015 = new TypeAdapter<Locale>() {
        ...
        C207629 r016 = new TypeAdapter<JsonElement>() {
            public JsonElement read(JsonReader jsonReader) throws IOException {
                switch (C208536.$SwitchMap$com$google$gson$stream$JsonToken[jsonReader.peek().ordinal()]) {
                    case 1:
    ...
    static /* synthetic */ class C208536 {
        ...
        static {
            ...
            L_0x0078:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.google.gson.internal.bind.TypeAdapters.C208536.<clinit>():void");
        }
    }
