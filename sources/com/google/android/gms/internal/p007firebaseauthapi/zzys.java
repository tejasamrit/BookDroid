...
abstract class zzys extends zzyw {
    final byte[] zza;
    final int zzb;
    int zzc;
    int zzd;
    ...
    public final void zzd(int i) {
        if (zzyw.zzb) {
            ...
            while ((i & -128) != 0) {
                ...
                int i2 = this.zzc;
                this.zzc = i2 + 1;
                zzacc.zzq(bArr, (long) i2, (byte) ((i & 127) | 128));
                i >>>= 7;
            }
            byte[] bArr2 = this.zza;
            int i3 = this.zzc;
            this.zzc = i3 + 1;
            zzacc.zzq(bArr2, (long) i3, (byte) i);
    ...
    public final void zze(long j) {
        if (zzyw.zzb) {
            ...
            while ((j & -128) != 0) {
                ...
                int i = this.zzc;
                this.zzc = i + 1;
                zzacc.zzq(bArr, (long) i, (byte) ((((int) j) & 127) | 128));
                j >>>= 7;
            }
            byte[] bArr2 = this.zza;
            int i2 = this.zzc;
            this.zzc = i2 + 1;
            zzacc.zzq(bArr2, (long) i2, (byte) ((int) j));
