...
public final class zzjw {
    ...
    public static int zzc(EllipticCurve ellipticCurve) throws GeneralSecurityException {
        return (zzb(ellipticCurve).subtract(BigInteger.ONE).bitLength() + 7) / 8;
    }

    public static BigInteger zzd(BigInteger bigInteger, boolean z, EllipticCurve ellipticCurve) throws GeneralSecurityException {
    ...
    public static ECPublicKey zzf(int i, byte[] bArr, byte[] bArr2) throws GeneralSecurityException {
        ECParameterSpec zze = zze(i);
        ECPoint eCPoint = new ECPoint(new BigInteger(1, bArr), new BigInteger(1, bArr2));
        zza(eCPoint, zze.getCurve());
        return (ECPublicKey) zzjy.zzg.zza("EC").generatePublic(new ECPublicKeySpec(eCPoint, zze));
    }
    ...
    public static ECParameterSpec zze(int i) throws NoSuchAlgorithmException {
        int i2 = i - 1;
        if (i2 == 0) {
