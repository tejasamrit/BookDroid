...
class zzabn<K extends Comparable<K>, V> extends AbstractMap<K, V> {
    private final int zza;
    /* access modifiers changed from: private */
    public List<zzabk> zzb = Collections.emptyList();
    /* access modifiers changed from: private */
    public Map<K, V> zzc = Collections.emptyMap();
    private boolean zzd;
    private volatile zzabm zze;
    private Map<K, V> zzf = Collections.emptyMap();

    /* synthetic */ zzabn(int i, zzabg zzabg) {
        this.zza = i;
    }
    ...
    public final V zzk(int i) {
        ...
        if (!this.zzc.isEmpty()) {
            ...
            List<zzabk> list = this.zzb;
            Map.Entry entry = (Map.Entry) it.next();
            list.add(new zzabk(this, (Comparable) entry.getKey(), entry.getValue()));
            it.remove();
        }
        return value;
    }
    ...
    public final Set<Map.Entry<K, V>> entrySet() {
        if (this.zze == null) {
            this.zze = new zzabm(this, (zzabg) null);
        }
        return this.zze;
    }
    ...
    public final boolean equals(Object obj) {
        ...
        int zzc2 = zzc();
        if (zzc2 != zzabn.zzc()) {
            return entrySet().equals(zzabn.entrySet());
        }
        for (int i = 0; i < zzc2; i++) {
            if (!zzd(i).equals(zzabn.zzd(i))) {
                return false;
            }
        }
        if (zzc2 != size) {
            return this.zzc.equals(zzabn.zzc);
        }
        return true;
    }
    ...
    public final V put(K k, V v) {
        ...
        int i2 = this.zza;
        if (size == i2) {
            zzabk remove = this.zzb.remove(i2 - 1);
            zzn().put(remove.zza(), remove.getValue());
        }
        this.zzb.add(i, new zzabk(this, k, v));
        return null;
    }
}
