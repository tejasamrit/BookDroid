        ...
        if ((i | i2 | ((length - i) - i2)) >= 0) {
            ...
            while (r12 < i4) {
                ...
                if (zzacd.zza(b2)) {
                    ...
                    if (i6 < i4 - 1) {
                        int i8 = i6 + 1;
                        zzacd.zze(b2, bArr[i6], bArr[i8], cArr, i3);
                        r12 = i8 + 1;
                        i3++;
                    } else {
                        throw zzzw.zzi();
                    ...
                    int i9 = i6 + 1;
                    int i10 = i9 + 1;
                    zzacd.zzf(b2, bArr[i6], bArr[i9], bArr[i10], cArr, i3);
                    i3 += 2;
                    r12 = i10 + 1;
                } else {
                    throw zzzw.zzi();
