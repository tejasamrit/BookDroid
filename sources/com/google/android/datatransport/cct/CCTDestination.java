...
public final class CCTDestination implements EncodedDestination {
    ...
    private static final Set<Encoding> SUPPORTED_ENCODINGS = Collections.unmodifiableSet(new HashSet(Arrays.asList(new Encoding[]{Encoding.m18of("proto"), Encoding.m18of("json")})));
