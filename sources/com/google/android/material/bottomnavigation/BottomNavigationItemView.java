...
public class BottomNavigationItemView extends FrameLayout implements MenuView.ItemView {
    ...
    public BottomNavigationItemView(Context context, AttributeSet attributeSet, int i) {
        ...
        LayoutInflater.from(context).inflate(C0907R.layout.design_bottom_navigation_item, this, true);
        setBackgroundResource(C0907R.C0909drawable.design_bottom_navigation_item_background);
        this.defaultMargin = resources.getDimensionPixelSize(C0907R.dimen.design_bottom_navigation_margin);
        this.icon = (ImageView) findViewById(C0907R.C0910id.icon);
        TextView textView = (TextView) findViewById(C0907R.C0910id.smallLabel);
        this.smallLabel = textView;
        TextView textView2 = (TextView) findViewById(C0907R.C0910id.largeLabel);
    ...
    public void onInitializeAccessibilityNodeInfo(AccessibilityNodeInfo accessibilityNodeInfo) {
        ...
        wrap.setRoleDescription(getResources().getString(C0907R.string.item_view_role_description));
    }
