...
public class Snackbar extends BaseTransientBottomBar<Snackbar> {
    private static final int[] SNACKBAR_BUTTON_STYLE_ATTR = {C0907R.attr.snackbarButtonStyle};
    private static final int[] SNACKBAR_CONTENT_STYLE_ATTRS = {C0907R.attr.snackbarButtonStyle, C0907R.attr.snackbarTextViewStyle};
    ...
    public static Snackbar make(View view, CharSequence charSequence, int i) {
        ...
        if (findSuitableParent != null) {
            SnackbarContentLayout snackbarContentLayout = (SnackbarContentLayout) LayoutInflater.from(findSuitableParent.getContext()).inflate(hasSnackbarContentStyleAttrs(findSuitableParent.getContext()) ? C0907R.layout.mtrl_layout_snackbar_include : C0907R.layout.design_layout_snackbar_include, findSuitableParent, false);
