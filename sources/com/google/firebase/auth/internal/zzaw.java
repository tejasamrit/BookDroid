...
final class zzaw extends BroadcastReceiver {
    ...
    public final void onReceive(Context context, Intent intent) {
        if (((Activity) this.zzb.get()) == null) {
            ...
            this.zzc.setException(zzte.zza(new Status(FirebaseError.ERROR_INTERNAL_ERROR, "Activity that started the web operation is no longer alive; see logcat for details")));
            zzax.zzd(context);
            ...
            sb.append(")");
            taskCompletionSource.setException(zzte.zza(zzai.zza(sb.toString())));
        } else if (zzbl.zzb(intent)) {
            this.zzc.setException(zzte.zza(zzbl.zzc(intent)));
            zzax.zzd(context);
        } else if (intent.hasExtra("com.google.firebase.auth.internal.EXTRA_CANCELED")) {
            this.zzc.setException(zzte.zza(zzai.zza("WEB_CONTEXT_CANCELED")));
            zzax.zzd(context);
        }
    }
}
