...
public final class RemoteStore implements WatchChangeAggregator.TargetMetadataProvider {
    ...
    public void handleWatchStreamClose(Status status) {
        if (Status.f489OK.equals(status)) {
    ...
    private void raiseWatchSnapshot(SnapshotVersion snapshotVersion) {
        ...
        for (Integer intValue2 : createRemoteEvent.getTargetMismatches()) {
            ...
            if (targetData2 != null) {
                this.listenTargets.put(Integer.valueOf(intValue3), targetData2.withResumeToken(ByteString.EMPTY, targetData2.getSnapshotVersion()));
