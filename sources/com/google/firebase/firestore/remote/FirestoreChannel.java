...
public class FirestoreChannel {
    private static final Metadata.Key<String> RESOURCE_PREFIX_HEADER = Metadata.Key.m262of("google-cloud-resource-prefix", Metadata.ASCII_STRING_MARSHALLER);
    private static final Metadata.Key<String> X_GOOG_API_CLIENT_HEADER = Metadata.Key.m262of("x-goog-api-client", Metadata.ASCII_STRING_MARSHALLER);
    ...
    static /* synthetic */ void lambda$runBidiStreamingRpc$0(FirestoreChannel firestoreChannel, final ClientCall[] clientCallArr, final IncomingStreamObserver incomingStreamObserver, Task task) {
        ...
        clientCallArr[0].start(new ClientCall.C2333Listener<RespT>() {
            public void onReady() {
            }
    ...
    static /* synthetic */ void lambda$runStreamingResponseRpc$1(FirestoreChannel firestoreChannel, final TaskCompletionSource taskCompletionSource, Object obj, Task task) {
        ...
        clientCall.start(new ClientCall.C2333Listener<RespT>() {
            public void onMessage(RespT respt) {
                arrayList.add(respt);
