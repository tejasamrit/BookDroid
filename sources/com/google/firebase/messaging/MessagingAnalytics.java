...
public class MessagingAnalytics {
    ...
    static {
        ...
        dataEncoder = new JsonDataEncoderBuilder().registerEncoder(FirelogAnalyticsEvent.FirelogAnalyticsEventWrapper.class, (ObjectEncoder) new FirelogAnalyticsEvent.FirelogAnalyticsEventWrapperEncoder()).registerEncoder((Class) cls, (ObjectEncoder) new FirelogAnalyticsEvent.FirelogAnalyticsEventEncoder()).build();
    }
    ...
    public static void logNotificationReceived(Intent intent) {
        ...
        if (shouldUploadFirelogAnalytics(intent)) {
            ...
            if (transportFactory != null) {
                logToFirelog(Constants.FirelogAnalytics.EventType.MESSAGE_DELIVERED, intent, transportFactory.getTransport(Constants.FirelogAnalytics.FCM_LOG_SOURCE, String.class, Encoding.m18of("json"), MessagingAnalytics$$Lambda$0.$instance));
            } else {
