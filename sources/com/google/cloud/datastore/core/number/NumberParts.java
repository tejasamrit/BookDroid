...
public final class NumberParts {
    ...
    public static NumberParts fromLong(long j) {
        ...
        return create(z, i2, (j & (~(1 << i2))) << (numberOfLeadingZeros + 1));
    }
    ...
    public static NumberParts fromDouble(double d) {
        ...
        if (i < DOUBLE_MIN_EXPONENT) {
            ...
            j = (j2 & (~(1 << (63 - numberOfLeadingZeros)))) << (numberOfLeadingZeros + 1);
    ...
    public double asDouble() {
        ...
        if (doubleRepresentationError != null) {
            ...
            if (exponent2 >= -1022) {
                ...
                significand2 = (significand2 >>> exponent3) | (1 << (52 - exponent3));
                j = 0;
            }
            long j3 = (j << 52) | significand2;
            if (negative()) {
                j2 = Long.MIN_VALUE;
            }
            return Double.longBitsToDouble(j3 | j2);
        }
    }
