...
final class FieldSet<T extends FieldDescriptorLite<T>> {
    ...
    /* synthetic */ FieldSet(SmallSortedMap smallSortedMap, C21371 r2) {
        this(smallSortedMap);
    }
    ...
    public static <T extends FieldDescriptorLite<T>> Builder<T> newBuilder() {
        return new Builder<>((C21371) null);
    }
    ...
    public static <T extends FieldDescriptorLite<T>> SmallSortedMap<T, Object> cloneAllFieldsMap(SmallSortedMap<T, Object> smallSortedMap, boolean z) {
        ...
        for (Map.Entry<T, Object> cloneFieldEntry : smallSortedMap.getOverflowEntries()) {
            cloneFieldEntry(newFieldMap, cloneFieldEntry, z);
        }
        return newFieldMap;
    }
    ...
    public void setField(T t, Object obj) {
        if (!t.isRepeated()) {
            ...
            for (Object verifyType : arrayList) {
                verifyType(t.getLiteType(), verifyType);
            }
            obj = arrayList;
        } else {
    ...
    public static boolean isValidType(WireFormat.FieldType fieldType, Object obj) {
        ...
        switch (C21371.$SwitchMap$com$google$protobuf$WireFormat$JavaType[fieldType.getJavaType().ordinal()]) {
            case 1:
    ...
    static /* synthetic */ class C21371 {
        ...
        static {
            ...
            L_0x0139:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.google.protobuf.FieldSet.C21371.<clinit>():void");
        }
    }
    ...
    static void writeElementNoTag(CodedOutputStream codedOutputStream, WireFormat.FieldType fieldType, Object obj) throws IOException {
        switch (C21371.$SwitchMap$com$google$protobuf$WireFormat$FieldType[fieldType.ordinal()]) {
            case 1:
    ...
    static final class Builder<T extends FieldDescriptorLite<T>> {
        ...
        public FieldSet<T> build() {
            ...
            FieldSet<T> fieldSet = new FieldSet<>(smallSortedMap, (C21371) null);
