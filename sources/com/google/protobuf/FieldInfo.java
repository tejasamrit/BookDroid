...
final class FieldInfo implements Comparable<FieldInfo> {
    ...
    static /* synthetic */ class C21351 {
        ...
        static {
            ...
            L_0x0033:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.google.protobuf.FieldInfo.C21351.<clinit>():void");
        }
    }

    public Class<?> getMessageFieldClass() {
        int i = C21351.$SwitchMap$com$google$protobuf$FieldType[this.type.ordinal()];
        if (i == 1 || i == 2) {
    ...
    public static Builder newBuilder() {
        return new Builder((C21351) null);
    }
