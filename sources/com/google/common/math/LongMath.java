...
public final class LongMath {
    ...
    static final byte[] maxLog10ForLeadingZeros = {19, Ascii.DC2, Ascii.DC2, Ascii.DC2, Ascii.DC2, 17, 17, 17, Ascii.DLE, Ascii.DLE, Ascii.DLE, Ascii.f233SI, Ascii.f233SI, Ascii.f233SI, Ascii.f233SI, Ascii.f234SO, Ascii.f234SO, Ascii.f234SO, Ascii.f224CR, Ascii.f224CR, Ascii.f224CR, Ascii.f226FF, Ascii.f226FF, Ascii.f226FF, Ascii.f226FF, Ascii.f237VT, Ascii.f237VT, Ascii.f237VT, 10, 10, 10, 9, 9, 9, 9, 8, 8, 8, 7, 7, 7, 6, 6, 6, 6, 5, 5, 5, 4, 4, 4, 3, 3, 3, 3, 2, 2, 2, 1, 1, 1, 0, 0, 0};
    ...
    static /* synthetic */ class C15751 {
        ...
        static {
            ...
            L_0x0060:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.google.common.math.LongMath.C15751.<clinit>():void");
        }
    }

    public static int log2(long j, RoundingMode roundingMode) {
        MathPreconditions.checkPositive("x", j);
        switch (C15751.$SwitchMap$java$math$RoundingMode[roundingMode.ordinal()]) {
            case 1:
    ...
    public static int log10(long r4, java.math.RoundingMode r6) {
        /*
            ...
            long[] r1 = powersOf10
            r2 = r1[r0]
            int[] r1 = com.google.common.math.LongMath.C15751.$SwitchMap$java$math$RoundingMode
            int r6 = r6.ordinal()
            r6 = r1[r6]
            switch(r6) {
    ...
    public static long divide(long r9, long r11, java.math.RoundingMode r13) {
        ...
        L_0x0010:
            ...
            r9 = 1
            r10 = r10 | r9
            int[] r7 = com.google.common.math.LongMath.C15751.$SwitchMap$java$math$RoundingMode
            int r8 = r13.ordinal()
            r7 = r7[r8]
            r8 = 0
            switch(r7) {
