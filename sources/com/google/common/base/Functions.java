...
public final class Functions {
    ...
    private static class FunctionComposition<A, B, C> implements Function<A, C>, Serializable {
        ...
        /* renamed from: f */
        private final Function<A, ? extends B> f238f;

        /* renamed from: g */
        private final Function<B, C> f239g;

        public FunctionComposition(Function<B, C> function, Function<A, ? extends B> function2) {
            this.f239g = (Function) Preconditions.checkNotNull(function);
            this.f238f = (Function) Preconditions.checkNotNull(function2);
        }

        public C apply(@NullableDecl A a) {
            return this.f239g.apply(this.f238f.apply(a));
        }
        ...
        public boolean equals(@NullableDecl Object obj) {
            ...
            if (!this.f238f.equals(functionComposition.f238f) || !this.f239g.equals(functionComposition.f239g)) {
                return false;
            }
            return true;
        }
        ...
        public int hashCode() {
            return this.f238f.hashCode() ^ this.f239g.hashCode();
        }

        public String toString() {
            return this.f239g + "(" + this.f238f + ")";
        }
    }
