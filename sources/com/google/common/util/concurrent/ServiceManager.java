...
public final class ServiceManager {
    ...
    public static final ListenerCallQueue.Event<C1681Listener> HEALTHY_EVENT = new ListenerCallQueue.Event<C1681Listener>() {
        public String toString() {
            return "healthy()";
        }

        public void call(C1681Listener listener) {
            listener.healthy();
        }
    };
    /* access modifiers changed from: private */
    public static final ListenerCallQueue.Event<C1681Listener> STOPPED_EVENT = new ListenerCallQueue.Event<C1681Listener>() {
        public String toString() {
            return "stopped()";
        }
    ...
    /* renamed from: com.google.common.util.concurrent.ServiceManager$Listener */
    public static abstract class C1681Listener {
    ...
    public ServiceManager(Iterable<? extends Service> iterable) {
        ...
        if (copyOf.isEmpty()) {
            ...
            copyOf = ImmutableList.m100of(new NoOpService());
        }
    ...
    public void addListener(C1681Listener listener, Executor executor) {
        this.state.addListener(listener, executor);
    }

    public void addListener(C1681Listener listener) {
    ...
    private static final class ServiceManagerState {
        ...
        final ListenerCallQueue<C1681Listener> listeners;
        ...
        public void awaitHealthy(long j, TimeUnit timeUnit) throws TimeoutException {
            ...
            try {
                ...
                throw new TimeoutException("Timeout waiting for the services to become healthy. The following services have not started: " + Multimaps.filterKeys(this.servicesByState, Predicates.m74in(ImmutableSet.m143of(Service.State.NEW, Service.State.STARTING))));
            } finally {
                this.monitor.leave();
            }
        }
        ...
        public void awaitStopped(long j, TimeUnit timeUnit) throws TimeoutException {
            ...
            try {
                if (!this.monitor.waitForUninterruptibly(this.stoppedGuard, j, timeUnit)) {
                    throw new TimeoutException("Timeout waiting for the services to stop. The following services have not stopped: " + Multimaps.filterKeys(this.servicesByState, Predicates.not(Predicates.m74in(EnumSet.of(Service.State.TERMINATED, Service.State.FAILED)))));
                }
            } finally {
                this.monitor.leave();
            }
        ...
        public void enqueueFailedEvent(final Service service) {
            this.listeners.enqueue(new ListenerCallQueue.Event<C1681Listener>() {
                public void call(C1681Listener listener) {
    ...
    private static final class ServiceListener extends Service.C1672Listener {
        ...
        public void failed(Service.State state2, Throwable th) {
            ...
            if (serviceManagerState != null) {
                if (!(this.service instanceof NoOpService)) {
                    ...
                    access$200.log(level, "Service " + this.service + " has failed in the " + state2 + " state.", th);
                }
