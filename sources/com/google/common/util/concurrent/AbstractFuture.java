...
public abstract class AbstractFuture<V> extends InternalFutureFailureAccess implements ListenableFuture<V> {
    ...
    /* access modifiers changed from: private */
    @NullableDecl
    public volatile C1621Listener listeners;
    /* access modifiers changed from: private */
    @NullableDecl
    ...
    /* renamed from: com.google.common.util.concurrent.AbstractFuture$Listener */
    private static final class C1621Listener {
        static final C1621Listener TOMBSTONE = new C1621Listener((Runnable) null, (Executor) null);
        final Executor executor;
        @NullableDecl
        C1621Listener next;
        final Runnable task;

        C1621Listener(Runnable runnable, Executor executor2) {
            this.task = runnable;
    ...
    public void addListener(Runnable runnable, Executor executor) {
        C1621Listener listener;
        Preconditions.checkNotNull(runnable, "Runnable was null.");
        Preconditions.checkNotNull(executor, "Executor was null.");
        if (isDone() || (listener = this.listeners) == C1621Listener.TOMBSTONE) {
            executeListener(runnable, executor);
        }
        C1621Listener listener2 = new C1621Listener(runnable, executor);
        do {
        ...
        } while (listener != C1621Listener.TOMBSTONE);
        executeListener(runnable, executor);
    }
    ...
    private C1621Listener clearListeners(C1621Listener listener) {
        C1621Listener listener2;
        do {
            listener2 = this.listeners;
        } while (!ATOMIC_HELPER.casListeners(this, listener2, C1621Listener.TOMBSTONE));
        C1621Listener listener3 = listener2;
        C1621Listener listener4 = listener;
        C1621Listener listener5 = listener3;
        while (listener5 != null) {
            C1621Listener listener6 = listener5.next;
    ...
    private static abstract class AtomicHelper {
        /* access modifiers changed from: package-private */
        public abstract boolean casListeners(AbstractFuture<?> abstractFuture, C1621Listener listener, C1621Listener listener2);
    ...
    private static final class UnsafeAtomicHelper extends AtomicHelper {
        ...
        /* JADX WARNING: Code restructure failed: missing block: B:3:?, code lost:
            r0 = (sun.misc.Unsafe) java.security.AccessController.doPrivileged(new com.google.common.util.concurrent.AbstractFuture.UnsafeAtomicHelper.C16221());
         */
        ...
        /* access modifiers changed from: package-private */
        public boolean casListeners(AbstractFuture<?> abstractFuture, C1621Listener listener, C1621Listener listener2) {
    ...
    private static final class SafeAtomicHelper extends AtomicHelper {
        final AtomicReferenceFieldUpdater<AbstractFuture, C1621Listener> listenersUpdater;
        final AtomicReferenceFieldUpdater<AbstractFuture, Object> valueUpdater;
        final AtomicReferenceFieldUpdater<Waiter, Waiter> waiterNextUpdater;
        final AtomicReferenceFieldUpdater<Waiter, Thread> waiterThreadUpdater;
        final AtomicReferenceFieldUpdater<AbstractFuture, Waiter> waitersUpdater;

        SafeAtomicHelper(AtomicReferenceFieldUpdater<Waiter, Thread> atomicReferenceFieldUpdater, AtomicReferenceFieldUpdater<Waiter, Waiter> atomicReferenceFieldUpdater2, AtomicReferenceFieldUpdater<AbstractFuture, Waiter> atomicReferenceFieldUpdater3, AtomicReferenceFieldUpdater<AbstractFuture, C1621Listener> atomicReferenceFieldUpdater4, AtomicReferenceFieldUpdater<AbstractFuture, Object> atomicReferenceFieldUpdater5) {
            super();
    ...
    private static final class SynchronizedHelper extends AtomicHelper {
        ...
        public boolean casListeners(AbstractFuture<?> abstractFuture, C1621Listener listener, C1621Listener listener2) {
            synchronized (abstractFuture) {
                ...
                C1621Listener unused = abstractFuture.listeners = listener2;
                return true;
            }
        }
