...
public abstract class AbstractService implements Service {
    private static final ListenerCallQueue.Event<Service.C1672Listener> RUNNING_EVENT = new ListenerCallQueue.Event<Service.C1672Listener>() {
        public String toString() {
            return "running()";
        }

        public void call(Service.C1672Listener listener) {
            listener.running();
        }
    };
    private static final ListenerCallQueue.Event<Service.C1672Listener> STARTING_EVENT = new ListenerCallQueue.Event<Service.C1672Listener>() {
        public String toString() {
            return "starting()";
        }
    ...
    private static final ListenerCallQueue.Event<Service.C1672Listener> STOPPING_FROM_RUNNING_EVENT = stoppingEvent(Service.State.RUNNING);
    private static final ListenerCallQueue.Event<Service.C1672Listener> STOPPING_FROM_STARTING_EVENT = stoppingEvent(Service.State.STARTING);
    private static final ListenerCallQueue.Event<Service.C1672Listener> TERMINATED_FROM_NEW_EVENT = terminatedEvent(Service.State.NEW);
    private static final ListenerCallQueue.Event<Service.C1672Listener> TERMINATED_FROM_RUNNING_EVENT = terminatedEvent(Service.State.RUNNING);
    private static final ListenerCallQueue.Event<Service.C1672Listener> TERMINATED_FROM_STARTING_EVENT = terminatedEvent(Service.State.STARTING);
    private static final ListenerCallQueue.Event<Service.C1672Listener> TERMINATED_FROM_STOPPING_EVENT = terminatedEvent(Service.State.STOPPING);
    ...
    private final ListenerCallQueue<Service.C1672Listener> listeners = new ListenerCallQueue<>();
    ...
    private static ListenerCallQueue.Event<Service.C1672Listener> terminatedEvent(final Service.State state) {
        return new ListenerCallQueue.Event<Service.C1672Listener>() {
            public void call(Service.C1672Listener listener) {
    ...
    private static ListenerCallQueue.Event<Service.C1672Listener> stoppingEvent(final Service.State state) {
        return new ListenerCallQueue.Event<Service.C1672Listener>() {
            public void call(Service.C1672Listener listener) {
    ...
    public final Service stopAsync() {
        if (this.monitor.enterIf(this.isStoppable)) {
            try {
                ...
                switch (C16376.$SwitchMap$com$google$common$util$concurrent$Service$State[state.ordinal()]) {
                    case 1:
    ...
    static /* synthetic */ class C16376 {
        ...
        static {
            ...
            L_0x0049:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.google.common.util.concurrent.AbstractService.C16376.<clinit>():void");
        }
    }
    ...
    public final void notifyFailed(Throwable th) {
        ...
        try {
            Service.State state = state();
            int i = C16376.$SwitchMap$com$google$common$util$concurrent$Service$State[state.ordinal()];
            if (i != 1) {
                if (i == 2 || i == 3 || i == 4) {
    ...
    public final void addListener(Service.C1672Listener listener, Executor executor) {
    ...
    private void enqueueFailedEvent(final Service.State state, final Throwable th) {
        this.listeners.enqueue(new ListenerCallQueue.Event<Service.C1672Listener>() {
            public void call(Service.C1672Listener listener) {
