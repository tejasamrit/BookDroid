...
public final class Status {
    ...
    static final Metadata.Key<Status> CODE_KEY = Metadata.Key.m266of("grpc-status", false, new StatusCodeMarshaller());
    ...
    /* renamed from: OK */
    public static final Status f489OK = Code.OK.toStatus();
    ...
    static {
        ...
        MESSAGE_KEY = Metadata.Key.m266of("grpc-message", false, statusMessageMarshaller);
    }
    ...
    public Status augmentDescription(String str) {
        ...
        return new Status(code2, this.description + "\n" + str, this.cause);
    }
        ...
        private static byte[] toAsciiStringSlow(byte[] bArr, int i) {
            ...
            while (i < bArr.length) {
                ...
                if (isEscapingChar(b)) {
                    ...
                    bArr2[i2 + 2] = bArr3[b & Ascii.f233SI];
                    i2 += 3;
                } else {
                    bArr2[i2] = b;
                    i2++;
