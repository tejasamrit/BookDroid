...
import p012io.grpc.internal.DnsNameResolver;
        ...
        public List<EquivalentAddressGroup> resolveSrv(DnsNameResolver.AddressResolver addressResolver, String str) throws Exception {
            ...
            for (String next : allRecords) {
                try {
                    ...
                    if (parseSrvRecord.host.endsWith(FileUtils.HIDDEN_PREFIX)) {
                    ...
                    logger3.log(level, "Can't find address for SRV record " + next, e);
                    if (th == null) {
                        level = Level.FINE;
                        th = e;
                    }
                    ...
                    logger4.log(level, "Failed to construct SRV record " + next, e);
                    if (th == null) {
                        level = Level.FINE;
                        th = e;
                    }
