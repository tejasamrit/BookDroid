...
public class ApplicationThreadDeframer implements Deframer, MessageDeframer.C2465Listener {
    /* access modifiers changed from: private */
    public final MessageDeframer deframer;
    /* access modifiers changed from: private */
    public final Queue<InputStream> messageReadQueue = new ArrayDeque();
    /* access modifiers changed from: private */
    public final MessageDeframer.C2465Listener storedListener;
    ...
    ApplicationThreadDeframer(MessageDeframer.C2465Listener listener, TransportExecutor transportExecutor2, MessageDeframer messageDeframer) {
        this.storedListener = (MessageDeframer.C2465Listener) Preconditions.checkNotNull(listener, ServiceSpecificExtraArgs.CastExtraArgs.LISTENER);
