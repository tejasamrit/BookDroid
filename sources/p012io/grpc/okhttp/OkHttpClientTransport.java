...
import p012io.grpc.internal.Http2Ping;
...
import p012io.grpc.okhttp.OkHttpClientStream;
import p012io.grpc.okhttp.OkHttpFrameLogger;
import p012io.grpc.okhttp.internal.ConnectionSpec;
import p012io.grpc.okhttp.internal.framed.ErrorCode;
import p012io.grpc.okhttp.internal.framed.FrameReader;
import p012io.grpc.okhttp.internal.framed.FrameWriter;
import p012io.grpc.okhttp.internal.framed.Header;
import p012io.grpc.okhttp.internal.framed.HeadersMode;
import p012io.grpc.okhttp.internal.framed.Http2;
...
class OkHttpClientTransport implements ConnectionClientTransport, ExceptionHandlingFrameWriter.TransportExceptionHandler {
    ...
    OkHttpClientTransport(String str, Executor executor2, FrameReader frameReader, FrameWriter frameWriter2, OkHttpFrameLogger okHttpFrameLogger, int i, Socket socket2, Supplier<Stopwatch> supplier, @Nullable Runnable runnable, SettableFuture<Void> settableFuture, int i2, int i3, Runnable runnable2, TransportTracer transportTracer2) {
        ...
        FrameWriter frameWriter3 = frameWriter2;
        this.testFrameWriter = (FrameWriter) Preconditions.checkNotNull(frameWriter2, "testFrameWriter");
        OkHttpFrameLogger okHttpFrameLogger2 = okHttpFrameLogger;
    ...
    public void ping(p012io.grpc.internal.ClientTransport.PingCallback r9, java.util.concurrent.Executor r10) {
        /*
            r8 = this;
        ...
        L_0x000c:
            ...
            p012io.grpc.internal.Http2Ping.notifyFailed(r9, r10, r1)     // Catch:{ all -> 0x0054 }
        ...
        L_0x0054:
            ...
            throw r9
        */
        throw new UnsupportedOperationException("Method not decompiled: p012io.grpc.okhttp.OkHttpClientTransport.ping(io.grpc.internal.ClientTransport$PingCallback, java.util.concurrent.Executor):void");
    }
    ...
    public OkHttpClientStream newStream(MethodDescriptor<?, ?> methodDescriptor, Metadata metadata, CallOptions callOptions) {
        ...
        synchronized (obj2) {
            try {
                ...
                obj = obj2;
                OkHttpClientStream okHttpClientStream = new OkHttpClientStream(methodDescriptor, metadata, exceptionHandlingFrameWriter, this, outboundFlowController, obj3, i, i2, str, str2, newClientContext, transportTracer2, callOptions, this.useGetForSafeMethods);
    ...
    private void startStream(OkHttpClientStream okHttpClientStream) {
        Preconditions.checkState(okHttpClientStream.mo36530id() == -1, "StreamId already assigned");
    ...
    public Runnable start(ManagedClientTransport.C2463Listener listener2) {
        this.listener = (ManagedClientTransport.C2463Listener) Preconditions.checkNotNull(listener2, ServiceSpecificExtraArgs.CastExtraArgs.LISTENER);
            ...
            public void run() {
                ...
                try {
                    if (OkHttpClientTransport.this.proxiedAddr == null) {
                        ...
                        access$1100 = okHttpClientTransport2.createHttpProxySocket(okHttpClientTransport2.proxiedAddr.getTargetAddress(), (InetSocketAddress) OkHttpClientTransport.this.proxiedAddr.getProxyAddress(), OkHttpClientTransport.this.proxiedAddr.getUsername(), OkHttpClientTransport.this.proxiedAddr.getPassword());
                    } else {
                    ...
                    ClientFrameHandler unused3 = okHttpClientTransport4.clientFrameHandler = new ClientFrameHandler(okHttpClientTransport4, http2.newReader(buffer2, true));
                    synchronized (OkHttpClientTransport.this.lock) {
                    ...
                    ClientFrameHandler unused6 = okHttpClientTransport5.clientFrameHandler = new ClientFrameHandler(okHttpClientTransport5, http2.newReader(buffer, true));
                    throw th;
                }
    ...
    class ClientFrameHandler implements FrameReader.Handler, Runnable {
        ...
        /* JADX WARNING: Code restructure failed: missing block: B:21:0x006c, code lost:
            r9 = r7.this$0;
            r10 = p012io.grpc.okhttp.internal.framed.ErrorCode.PROTOCOL_ERROR;
            p012io.grpc.okhttp.OkHttpClientTransport.access$2200(r9, r10, "Received window_update for unknown stream: " + r8);
         */
        ...
        public void windowUpdate(int r8, long r9) {
            /*
                ...
                io.grpc.okhttp.OkHttpFrameLogger$Direction r1 = p012io.grpc.okhttp.OkHttpFrameLogger.Direction.INBOUND
                ...
                io.grpc.okhttp.OkHttpClientTransport r8 = p012io.grpc.okhttp.OkHttpClientTransport.this
                io.grpc.okhttp.internal.framed.ErrorCode r10 = p012io.grpc.okhttp.internal.framed.ErrorCode.PROTOCOL_ERROR
                r8.onError(r10, r9)
                goto L_0x002b
            L_0x0019:
                io.grpc.okhttp.OkHttpClientTransport r0 = p012io.grpc.okhttp.OkHttpClientTransport.this
                io.grpc.Status r10 = p012io.grpc.Status.INTERNAL
                io.grpc.Status r2 = r10.withDescription(r9)
                io.grpc.internal.ClientStreamListener$RpcProgress r3 = p012io.grpc.internal.ClientStreamListener.RpcProgress.PROCESSED
                r4 = 0
                io.grpc.okhttp.internal.framed.ErrorCode r5 = p012io.grpc.okhttp.internal.framed.ErrorCode.PROTOCOL_ERROR
                r6 = 0
                r1 = r8
            ...
            L_0x002c:
                r0 = 0
                io.grpc.okhttp.OkHttpClientTransport r1 = p012io.grpc.okhttp.OkHttpClientTransport.this
                java.lang.Object r1 = r1.lock
                monitor-enter(r1)
                if (r8 != 0) goto L_0x0043
                io.grpc.okhttp.OkHttpClientTransport r8 = p012io.grpc.okhttp.OkHttpClientTransport.this     // Catch:{ all -> 0x0085 }
                ...
                return
            L_0x0043:
                io.grpc.okhttp.OkHttpClientTransport r2 = p012io.grpc.okhttp.OkHttpClientTransport.this     // Catch:{ all -> 0x0085 }
                ...
                io.grpc.okhttp.OkHttpClientStream r2 = (p012io.grpc.okhttp.OkHttpClientStream) r2     // Catch:{ all -> 0x0085 }
                if (r2 == 0) goto L_0x0060
                io.grpc.okhttp.OkHttpClientTransport r3 = p012io.grpc.okhttp.OkHttpClientTransport.this     // Catch:{ all -> 0x0085 }
                io.grpc.okhttp.OutboundFlowController r3 = r3.outboundFlow     // Catch:{ all -> 0x0085 }
                int r10 = (int) r9     // Catch:{ all -> 0x0085 }
                r3.windowUpdate(r2, r10)     // Catch:{ all -> 0x0085 }
                goto L_0x0069
            L_0x0060:
                io.grpc.okhttp.OkHttpClientTransport r9 = p012io.grpc.okhttp.OkHttpClientTransport.this     // Catch:{ all -> 0x0085 }
            ...
            L_0x0069:
                ...
                io.grpc.okhttp.OkHttpClientTransport r9 = p012io.grpc.okhttp.OkHttpClientTransport.this
                io.grpc.okhttp.internal.framed.ErrorCode r10 = p012io.grpc.okhttp.internal.framed.ErrorCode.PROTOCOL_ERROR
            ...
            L_0x0085:
                ...
                throw r8
            */
            throw new UnsupportedOperationException("Method not decompiled: p012io.grpc.okhttp.OkHttpClientTransport.ClientFrameHandler.windowUpdate(int, long):void");
        }
    }
}
