...
final class DistinguishedNameParser {
    ...
    private java.lang.String nextAT() {
        ...
        L_0x00da:
            ...
            throw r0
        */
        throw new UnsupportedOperationException("Method not decompiled: p012io.grpc.okhttp.internal.DistinguishedNameParser.nextAT():java.lang.String");
    }
    ...
    private String quotedAV() {
        ...
        while (true) {
            ...
            if (i2 != this.length) {
                ...
                throw new IllegalStateException("Unexpected end of DN: " + this.f494dn);
            }
        }
    }
    ...
    private java.lang.String escapedAV() {
        ...
        L_0x0097:
            ...
            return r0
        */
        throw new UnsupportedOperationException("Method not decompiled: p012io.grpc.okhttp.internal.DistinguishedNameParser.escapedAV():java.lang.String");
    }
    ...
    private int getByte(int i) {
        ...
        if (i4 < this.length) {
            ...
            if (c >= '0' && c <= '9') {
                ...
                throw new IllegalStateException("Malformed DN: " + this.f494dn);
            } else {
                i2 = c - '7';
            }
            char c2 = cArr[i4];
    ...
    public String findMostSpecific(String str) {
        ...
        this.end = 0;
        this.cur = 0;
        this.chars = this.f494dn.toCharArray();
