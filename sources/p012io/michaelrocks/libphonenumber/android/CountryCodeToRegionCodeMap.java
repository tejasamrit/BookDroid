...
/* renamed from: io.michaelrocks.libphonenumber.android.CountryCodeToRegionCodeMap */
public class CountryCodeToRegionCodeMap {
    static Map<Integer, List<String>> getCountryCodeToRegionCodeMap() {
        ...
        arrayList106.add("GI");
        hashMap.put(Integer.valueOf(BaseAnimation.DEFAULT_ANIMATION_TIME), arrayList106);
        ...
        hashMap.put(Integer.valueOf(LogSeverity.EMERGENCY_VALUE), arrayList177);
